...
<!--				End Page 3-->
			...
			<div class="row text-center page-nav">
				<div class="col-lg-12 nav">
					<ul class="pagination">
						<li class="active">
							<a href="#" class="pager-lnk" id="pg-1-lnk" data-target="page1">1</a>
						</li>
						<li>
							<a href="#" class="pager-lnk" id="pg-2-lnk" data-target="page2">2</a>
						</li>
						<li>
							<a href="#" class="pager-lnk" id="pg-3-lnk" data-target="page3">3</a>
						</li>
					</ul>
				</div>
			</div>
